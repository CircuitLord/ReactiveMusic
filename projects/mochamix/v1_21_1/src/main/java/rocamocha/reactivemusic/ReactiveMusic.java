...
import rocamocha.reactivemusic.commands.AwaitValueCommandUtility;
import rocamocha.reactivemusic.commands.HelpCommandHandlers;
import rocamocha.reactivemusic.commands.PlayerCommandHandlers;
import rocamocha.reactivemusic.commands.PluginCommandHandlers;
import rocamocha.reactivemusic.commands.SongpackCommandHandlers;
import rocamocha.reactivemusic.config.ModConfig;
import rocamocha.reactivemusic.impl.audio.RMPlayerManager;
...
public class ReactiveMusic implements ModInitializer {
	...
	@Override public void onInitialize() {
		...
		if (rocamocha.reactivemusic.api.ReactiveMusicUtils.isClientEnv()) {
			try {
				Class.forName("rocamocha.reactivemusic.ClientBootstrap")
