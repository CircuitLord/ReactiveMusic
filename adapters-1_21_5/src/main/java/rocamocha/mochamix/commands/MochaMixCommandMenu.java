    ...
    public static int main(CommandContext<FabricClientCommandSource> context) {
        ...
        Text playerLink = Text.literal("Player Information")
            .setStyle(Style.EMPTY
                ...
                .withUnderline(true)
                .withClickEvent(new ClickEvent.RunCommand("/mochamix api player"))
                .withHoverEvent(new HoverEvent.ShowText(Text.literal("Shows current player state and info")))
            );
        ...
        Text mainhandLink = Text.literal("Mainhand Analysis")  
            .setStyle(Style.EMPTY
                ...
                .withUnderline(true)
                .withClickEvent(new ClickEvent.RunCommand("/mochamix api player mainhand"))
            );
        ...
        Text entitiesLink = Text.literal("Nearby Entities")
            .setStyle(Style.EMPTY
                ...
                .withUnderline(true)
                .withClickEvent(new ClickEvent.RunCommand("/mochamix api player nearby_entities"))
            );
