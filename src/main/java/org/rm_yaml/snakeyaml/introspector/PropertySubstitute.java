 ...
 * the License.
 */
package org.rm_yaml.snakeyaml.introspector;
...
import org.rm_yaml.snakeyaml.internal.Logger.Level;
...
public class PropertySubstitute extends Property {
  ...
  private Method discoverMethod(Class<?> type, String name, Class<?>... params) {
    ...
    if (log.isLoggable(Level.WARNING)) {
      log.warn(String.format("Failed to find [%s(%d args)] for %s.%s", name, params.length,
